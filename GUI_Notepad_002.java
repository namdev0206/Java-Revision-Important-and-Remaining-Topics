...
class MenuTest2 extends Frame implements ActionListener {
    MenuBar mb; // MenuBar
    ...
    public MenuTest2() 
	{
        ...
        mFile.add(miOpen);
        mFile.add(miSave);
        mFile.addSeparator(); // Proper way to add a separator
        mFile.add(miExit);
        mb.add(mFile);
        ...
        add(t1); // Correct way to add TextArea to the Frame
